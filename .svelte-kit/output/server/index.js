...
`),O=[];t.dev&&O.push(" data-sveltekit"),v.style_needs_nonce&&O.push(` nonce="${v.nonce}"`),v.add_style(x),_+=`
	...
	<link ${O.join(" ")}>`}).join(""),s.router||s.hydrate){_+=Array.from(d).map(O=>`
