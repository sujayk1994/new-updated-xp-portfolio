...
<div
    ...
    class="window absolute flex flex-col bg-xp-yellow {animation_enabled ? 'transition duration-300' : ''}  {minimized ? `opacity-0` : ''} {isMobile ? 'mobile-window' : ''} {isMobile && minimized ? 'minimized-mobile' : ''}"
